    ...
    return (
        <div>
            <h2>Diphtheria / Tetanus / Pertussis (DTaP / DTP / DT / Td / Tdap)</h2>
                <p>3 dose primary series and 1 booster dose of tdap / td within the last five years</p>
                <p>1 dose of Tdap is required if at least five years have passed since the last dose of tetanus-containing vaccine</p>
                <VaccineCounter />
                <hr />
            <h2>Polio</h2>
